...
public class L01 {
	...
	public static void main(String[] args) {
     ...
     // array to uzunluğu değiştirilemeyen bir list’e cevirir.
     // Yani; yeni oluşturulan listte add(), remove() ve clear() methodlarını kullanamazsınız.
        sl.add("Ali");
        sl.remove(1);
        sl.clear();
        // methodlari Run Time Error verir. UnsupportedOperation Exception
