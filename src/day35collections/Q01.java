...
public class Q01 {
	...
	public static void main(String[] args) {
		...
		//Queue'da ilk eklenen ilk silinir==> FIFO : First In First Out
		...
		q01.peek();//Ilk elemani size verir, Queue'dan silmez. element() method'undan farki
		...
		//PriorityQueue kullanirsaniz bazen natural order' agore dizer, 
