...
public class Araba {
	...
	//	Araba a6 = new Araba("Coralla", 120, 120 ); // Cte veriyor 
	//  cunku "The constructor Araba(String, int, int) is undefined"
	// string int int seklinde tanimli bir constructor bulunmamaktadir.
